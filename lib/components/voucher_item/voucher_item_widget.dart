...
export 'voucher_item_model.dart';
...
class _VoucherItemWidgetState extends State<VoucherItemWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VoucherItemModel());
  }
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    colors: [Color(0x3314181B), Color(0xC314181B)],
                    stops: [0.0, 1.0],
                                  ...
                                  text: TextSpan(
                                    children: [
                                      TextSpan(
                                        text:
                                            FFLocalizations.of(context).getText(
                                          '3qc1a3vq' /* 40% discount for purchases ove... */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .titleSmall
                                            .override(
